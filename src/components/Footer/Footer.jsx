        ...
        <div className="footer_content">
          ...
          <div className="footer_section">
            ...
            <p className="footer_description">
              Handcrafted cakes made with love and premium ingredients. Making every celebration sweeter since 2026.
            </p>
          ...
          <div className="footer_section">
            ...
            <div className="contact_info">
              <div className="contact_item">
                ...
                <span>Sweet Delight, Medawala, Harispattuwa, Kandy</span>
              </div>
              <div className="contact_item">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="tel:+1234567890">+94 70 234 1433</a>
              </div>
              <div className="contact_item">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="mailto:info@sweetdelights.com">info@sweetdelights.lk</a>
              </div>
            </div>
          </div>
        </div>
